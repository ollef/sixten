...
usedPiView
  :: (Syntax e, Monad e, Traversable e)
  => e v
...
telescope :: (Syntax e, Monad e) => e v -> Telescope e v
telescope (pisView -> (tele, _)) = tele

pisView :: (Syntax e, Monad e) => e v -> (Telescope e v, Scope Tele e v)
pisView = bindingsView piView

betaApp :: (Syntax e, Monad e, Foldable e) => e v -> Annotation -> e v -> e v
